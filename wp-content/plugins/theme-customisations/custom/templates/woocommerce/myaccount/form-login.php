...
<div class="u-columns col2-set overnight-customer-login" id="customer_login">
...
<?php endif; ?>
		...
		<form class="woocommerce-form woocommerce-form-login login overnight-login" method="post">
			...
			<p class="form-row">
				...
				<button type="submit" class="woocommerce-Button button save-changes-overnight" name="login" value="<?php esc_attr_e( 'Login', 'woocommerce' ); ?>"><?php esc_html_e( 'Login', 'woocommerce' ); ?></button>
				<label class="overnight-label-rememberme woocommerce-form__label woocommerce-form__label-for-checkbox inline">
...
<?php if ( get_option( 'woocommerce_enable_myaccount_registration' ) === 'yes' ) : ?>
	...
	<div class="u-column2 col-2">
		...
		<form method="post" class="register overnight-register">
			...
			<p class="woocommerce-FormRow form-row">
				...
				<button type="submit" class="woocommerce-Button button save-changes-overnight" name="register" value="<?php esc_attr_e( 'Register', 'woocommerce' ); ?>"><?php esc_html_e( 'Register', 'woocommerce' ); ?></button>
			</p>

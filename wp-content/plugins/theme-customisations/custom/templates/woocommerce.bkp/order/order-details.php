...
<div id="checkout-form-wrap">
    <div class="shopping--content-wrap" id="shopping--content-wrap-id">
        <div class="shopping--content-left">
            <div class="shopping--content-wrap-block">
                ...
                foreach ($order_items as $item_id => $item) {
                    ...
                    ?>
                    <div class="shopping--content-top--wrap info-title">
                        <?php
                        $value = wc_get_template_html( 'order/order-details-item-fr.php', [
                            'order'			     => $order,
                            'item_id'		     => $item_id,
                            'item'			     => $item,
                        ...
                        /*echo '<pre>';
                        echo htmlspecialchars( $d->saveXML() );
                        echo '</pre>';*/

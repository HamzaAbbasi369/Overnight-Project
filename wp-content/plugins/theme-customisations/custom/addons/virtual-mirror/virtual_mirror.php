...
function ong_woocommerce_virtual_mirror()
{
    ...
    <div class="float-right hide-for-small-only tooltipVirtual"
        ...
        <button class="button try_on show-virtual-mirror mirror-single"
                href="#"
                data-href="<?=ong_woocommerce_virtual_mirror_plugin_url()?>/virtual-mirror1.0/core/vmjs.html?gender=female&frameFile=FRAME-FILE&amp;frameSize=FRAME-SIZE&amp;frameName=<?=urlencode($product->get_title())?>&amp;lang=en"
                rel="nofollow"
...
function ong_virtual_mirror_enqueue_scripts() {
	...
	jQuery(document).ready(function($){
		    ...
		    var vto_image = vto_image_b.substr(0, vto_image_b.indexOf('-FRONT') + 11);

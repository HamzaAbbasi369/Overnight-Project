<?php
function USPSLabel($FromName,$FromAddress1,$FromAddress2,$FromFirm,$FromCity,$FromState,$FromZip5 ) {
...
// ========== CHANGE THESE VALUES TO MATCH YOUR OWN ===========
    ...
    $userName = '994GIDON0622';

    $ToName = 'Overnight Glasses';
    $ToAddress2 = '16430 Vanowen st';
    $ToCity = 'Van Nuys';
    $ToState = 'CA';
    $ToZip5 = '91406';
...
//$url="http://testing.shippingapis.com/ShippingAPITest.dll"; //Test

    $url = "https://Secure.ShippingAPIs.com/ShippingAPI.dll"; // Prod
    $ch = curl_init();
...
//$data = "API=DelivConfirmCertifyV3&XML=<DelivConfirmCertifyV3.0Request USERID=\"$userName\">

...
final class TA_WC_Variation_Swatches {
    ...
    public function init_hooks()
    {
        ...
        if (is_admin()) {
            add_action('init', ['TA_WC_Variation_Swatches_Admin', 'instance']);
        }
//        else {
            add_action('init', ['TA_WC_Variation_Swatches_Frontend', 'instance']);
//        }
    }
...
add_action('init', 'ta_wc_variation_swatches_constructor', - 1);

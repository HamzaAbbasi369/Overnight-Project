...
class Alg_WC_Checkout_Files_Upload_Settings_General extends Alg_WC_Checkout_Files_Upload_Settings_Section {
	...
	function get_settings() {
		...
		$settings = array(
			array(
				'title'    => __( 'File Upload Options', 'checkout-files-upload-woocommerce' ),
				'type'     => 'title',
				'desc'     => __( '', 'checkout-files-upload-woocommerce' ),
				'id'       => 'alg_checkout_files_upload_general_options',
			),
			array(
				'title'    => __( 'Files Upload', 'checkout-files-upload-woocommerce' ),
				'desc'     => '<strong>' . __( 'Enable plugin', 'checkout-files-upload-woocommerce' ) . '</strong>',
				'desc_tip' => __( '', 'checkout-files-upload-woocommerce' ),

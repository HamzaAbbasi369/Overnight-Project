...
<div id="step2">
	...
	<div style="margin:20px 0 0 0px;">
		<label for="prism"><input type="checkbox" id="prism" name="prism" onchange="ShowPrism();"/> <span style="font-size:16px;">&nbsp;&nbsp;&nbsp;Add Prism </span></label>   <span class="glyphicon glyphicon-question-sign" rel="tooltip" title="<b>Prism:</b> Refers to an extra feature that in some cases needed to help the eyes stay in proper alignment."></span>
	</div>
	<div style="clear:left;"></div>

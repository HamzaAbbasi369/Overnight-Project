...
foreach ( WC()->cart->get_cart() as $cart_item_key => $cart_item ) {
	...
	if(in_array($cart_product->id,$lens_packages_id) ){
		$show_combine = 1;
	}		
}
if($show_combine == 1){
...
<div class="shopping--content-summary-wrap large-3 medium-12 small-12 column cart_totals <?php if ( WC()->customer->has_calculated_shipping() ) echo 'calculated_shipping'; ?>">
    <p class="shopping-sum-title">Combine your lens</p>
    <div class="shopping--content-summary">

		<p id="shopping-total-order" class="shopping-total-order clearfix">You have a lens into your cart, please combine it with a frame or delete from the cart before procede to checkout</p>

		<div class="wc-proceed to-checkout">
			<a href="/" class="shopping-checkout checkout-button button">Combine with a Frame</a>
		</div>
    </div>
</div>
...
<div class="shopping--content-summary-wrap large-3 medium-12 small-12 column cart_totals <?php if ( WC()->customer->has_calculated_shipping() ) echo 'calculated_shipping'; ?>">
    ...
    <div class="shopping--content-summary">
            ...
            <p id="shopping-sub-total" class="shopping-sub-total clearfix">
